...
function Navbar() {
  return (
    <div className="font-medium">
      ...
      <div className=" flex justify-between items-center px-8 md:px-25 bg-white/98 w-full h-15 pt-12 md:pt-0">
        <div className="flex items-center gap-2 ">
          <img src={assets.logo} alt="Logo" className="h-8" />
          <Button
            className="hover:bg-gray-100  text-[#666666] hidden md:flex  px-4 cursor-pointer "
            size="lg"
            variant="ghost"
          >
            Flux Ai
