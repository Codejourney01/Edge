...
function Navbar() {
  return (
    <div className="font-medium">
      <div className="w-full bg-accent text-[14px] cursor-pointer flex justify-center items-center py-[10px]">
      ...
      <div className="flex justify-between items-center px-50 bg-white w-full h-15">
